...
" target="_blank" className="text-light">
              <i className="bi bi-facebook fa-5x " id="logo" />
              </Link>
            </li>
            <li className="footer-item d-inline-block ">
            <Link to="https://twitter.com/CreativeTech_SA
" target="_blank" className="text-light">
              <i className="bi bi-twitter fa-5x" id="logo" />
              </Link>
            </li>
            <li className="footer-item d-inline-block ">
...
" target="_blank" className="text-light">
              <i className="bi bi-instagram fa-5x  " id="logo" />
              </Link>
            </li>
            <li className="footer-item d-inline-block ">
...
" target="_blank" className="text-light">
              <i className="bi bi-linkedin fa-5x " id="logo" />
              </Link>
            </li>
            <li className="footer-item d-inline-block ">
            <Link to="https://www.youtube.com/channel/UCfgmC6NoXQAIFcg7X1CIvkg
" target="_blank" className="text-light">
              <i className="bi bi-youtube fa-5x " id="logo" />
              </Link>
            </li>
            <li className="footer-item d-inline-block ">
...
" target="_blank" className="text-light">
              <i className="bi bi-tiktok fa-5x " id="logo" />
              </Link>
            </li>
            <li className="footer-item d-inline-block ">
            <Link to="https://t.snapchat.com/jle8iv3f
" target="_blank" className="text-light">
              <i className="bi bi-snapchat fa-5x  " id="logo" />
              </Link>
            </li>
          </ul>
        </div>
